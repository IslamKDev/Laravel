...
CREATE DATABASE IF NOT EXISTS `IK_gsb_E5` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `IK_gsb_E5`;
grant all privileges on IK_gsb_E5.* to 'usersio'@'localhost' identified by 'sio';
